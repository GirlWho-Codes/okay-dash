...
} from '../../../../components/sections/fixedtransactions';
...
export async function getServerSideProps(ctx) {
   ...
   const res = await axios.get(
      `${process.env.NEXT_PUBLIC_BASE_URL}/api/v1/admin/view-fixed-savings/${id}`,
      {
         headers: {
...
export default function FixedSavings({ personalData }) {
         ...
         <section className='space-y-4'>
            ...
            <div className='start space-x-5'>
               <Image
                  ...
                  alt='lifesaver user'
               />
               <span className='text-xl font-bold'>{personalData.fixed_savings.withdrawal_account_details?.account_name}</span>
            </div>
